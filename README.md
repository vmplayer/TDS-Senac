...
> Repositório oficial: [Acessar](https://github.com/dhDSouza/UC1_TDS26-1M)
>
...
**Linguagens usadas:** Git Bash, Terminal (Windows), JavaScript.

> Repositório oficial: [Acessar](https://github.com/dhDSouza/UC2_TDS26-1M)
>
> Professor: [Daniel Henrique de Souza](https://github.com/dhDSouza)

### Unidade Curricular 5 - Analisar orientações técnicas
Unidade curricular que demonstra do **básico sobre inglês** até **leitura** e **entendimento pleno** de **documentações** e **linhas de código**.
